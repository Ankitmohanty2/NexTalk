      ...
      <div className="flex-between gap-6">
        <div className="hidden md:flex items-center gap-2">
          <Link
            ...
            className="flex items-center gap-2 px-3 py-1.5 bg-[#1b1f23] hover:bg-[#24292e] rounded-md transition-all duration-200 border border-gray-600/20"
          >
          ...
          <div className="flex items-center px-3 py-1.5 bg-[#1b1f23] rounded-md border border-gray-600/20">
